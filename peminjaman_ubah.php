    ...
    <div class="card-body">
        ...
        <div class="col-md-12">
            ...
            $id =$_GET['id'];
                ...
                <div class="col-md-8">
                <input type="date"value="<?php echo $data['tggl_peminjaman']; ?>"
                class="form-control"name="tggl_peminjaman">
                    </div>
                </div>
                <div class="row mb-3">
                <div class="col-md-2">Tanggal Peminjaman</div>
                <div class="col-md-8">
                <input type="date"value="<?php echo $data['tggl_pengembalian']; ?>"
                class="form-control"name="tggl_pengembalian">
                        </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <select name="status_peminjaman" class="form-control">
                                   ...
                                   <option value="dikembalikan"> <?php if($data['status_peminjaman']
                                   == 'dikembalikan') echo 'selected'; ?>Dikembalikan</option>
                                </select>
                        </div>
                        </div>
            <div class="row">
